...
def dic2tbl_hor(d):
    return dbc.Table(
        children=[
            ...
            html.Tbody(html.Tr([html.Td(process_cell(x)) for x in d.values()]))],
        bordered=True,
        hover=False,
        responsive=True,
        striped=True,
        style={"while-space": "normal", "padding": "20px"})
...
def ToStr(v, max_len=None):
    ...
    if len(s) > max_len:
        ...
        btn = dbc.Button("...", id={"type": str(v), "index": unique_id[0]},
                         ...
                         style={"margin-left": "5px", "width": "28px", "height": "20px", "text-align": "center buttom",
                                "line-height": "5px"})
